...
Then just run "ant" in SoundHelix' main directory, which is the directory containing the ant
...
to use as a parameter. For example, "run.bat examples\SoundHelix-Piano.xml".
