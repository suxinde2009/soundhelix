...
public final class VersionUtils {
     ...
     * returned. The pattern is a comma-separated list of version specifications, where each is one of "<version>", "<version>+",
     * and "<version1>-<version2>". If any version specification matches, the check is considered as successful.
     *  
